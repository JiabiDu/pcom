...
sinputs=[
  (1,1,['salinity',],'stations/station_twdb_salinity.bp','salt2'), #vertical profile
  (1,0,['salinity'],'stations/station_tse.bp','salt'), #at single layer
  ...
  (1,0,['sigWaveHeight','dominantDirection','peakPeriod'],'stations/station_ndbc_wave.bp','wave'),
]
#optional
...
#resource requst 
walltime='02:00:00' 
qnode='grace'; nnode=2; ppn=36; mem='16G'
