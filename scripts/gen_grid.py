...
headers=("etopo1","ncei19_MS_LA", "ncei19_AL_nwFL","tx_ncei19")

bdir=r'/sciclone/data10/wangzg/DEM/npz'  #directory of DEM data
sdir='/sciclone/data10/wangzg/CBP/setup_files' #ChesBay setup dir
ogd=read_schism_hgrid('../v000/hgrid.gr3')
...
#bp=read_schism_reg('{}/region/estuary.reg'.format(sdir))
